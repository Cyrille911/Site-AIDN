...
urlpatterns = [
    path('academy/', views.academy_index, name='academy_index'),
    path('strategie/', views.strategy_index, name='strategy_index'),
    ...
    path('invite/<int:plan_id>/', views.invite_to_plan_action, name='invite_to_plan_action'),
]