...
class User(AbstractUser):
    ...
    # SaaS multi-tenant : organisations auxquelles l'utilisateur appartient
    ...
    # Plans d'actions auxquels l'utilisateur est associé
    plans_action = models.ManyToManyField(
        'planning.PlanAction',
        through='planning.PlanActionMember',
        related_name='participants',
        blank=True,
        verbose_name='Plans d\'action'
    )
